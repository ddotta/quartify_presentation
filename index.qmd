...
- 📐 **Fonctionnalités spécifiques**: boîtes callout, onglets tabset, diagrammes mermaid...
...
- 🗂️ **[Sections RStudio](https://docs.posit.co/ide/user/ide/guide/code/code-sections.html#code-sections)** : Reconnaissance automatique
...
- 📑 **[Tabsets](https://quarto.org/docs/interactive/layout.html#tabset-panel)** : Organisation en onglets
- 📊 **[Diagrammes Mermaid](https://quarto.org/docs/authoring/diagrams.html)** : Flowcharts, séquences...
...
- 📚 **[Quarto Books](https://quarto.org/docs/books/)** : Répertoires vers livres navigables
...
[Syntaxe complète](https://ddotta.github.io/quartify/reference/rtoqmd.html)

---

## 🔧 Paramètres de personnalisation pour rtoqmd()


::: {.incremental}
- **theme** : Parmi 25 thèmes Quarto (défaut: "cosmo")
- **code_fold** : Plier les blocs de code (défaut : FALSE)
- **number_sections** : Numéroter les sections ? (défaut: TRUE)
...
::: {.incremental}
- **render_html** : Générer le HTML ? (défaut: TRUE)
- **output_html_file** : Nom du fichier HTML de sortie
- **open_html** : Ouvrir le HTML ? (défaut: FALSE)
...
rtoqmd(
  ...
  output_file = "analyse_qualite.qmd",
...
[Syntaxe complète](https://ddotta.github.io/quartify/reference/rtoqmd_dir.html)
...
rtoqmd_dir(
  ...
  book_title  = "Documentation_projet_SSP_2026",
  author = "Mon équipe",
  theme = "cosmo",
  render_html = TRUE
)
...
#Ceci n'apparaitra PAS (pas d'espace après #)
#TODO: Ceci non plus
...
:::
::: {.column width="50%"}
Génère dans le fichier HTML un callout mis en forme :  
...
::: {.incremental}
- ✨ **Formatage automatique** : Suit le [style guide tidyverse](https://style.tidyverse.org/)
...
::: {.incremental}
- ⚠️ Le paramètre `apply_styler` permet de formater **définitivement** vos fichiers de scripts R.
...
- 📖 **Site documentation** : [ddotta.github.io/quartify](https://ddotta.github.io/quartify/)
...
- 📝 **Exemples** : Dans le repo (`inst/examples/`)
- 📚 **Quarto docs** : [quarto.org](https://quarto.org)
- 💬 **Issues GitHub** : [Questions et support](https://github.com/ddotta/quartify/issues)
:::
